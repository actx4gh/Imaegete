...
class UIInitializer:
    ...
    def init_ui(self):
        ...
        self.main_window.top_bar_layout.setContentsMargins(0, 0, 0, 0)  # Ensure no margins
        ...
        self.main_window.top_splitter.setContentsMargins(0, 0, 0, 0)  # Ensure no margins
        ...
        self.main_window.bottom_splitter.setContentsMargins(0, 0, 0, 0)  # Ensure no margins
